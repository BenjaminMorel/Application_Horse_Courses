...
public class DatabaseInitializer {
    ...
    private static void addRide(final AppDatabase db, final String description, final double lenght, final double duration, final int difficulty,
                                final String location,final String positions,final String time,final double price){
        Ride ride = new Ride(description,lenght,duration,difficulty,location, positions,time,price);
